...
import com.ns.mutiphotochoser.utils.FragmentsPopListener;
...
//            如果是在已选择的预览模式，移除当前图片， 如果是全部图片的预览模式则不需要操作移除操作
            if (!all) {
...
//            字数增减
    ...
    private FragmentsPopListener mPopListener;

    public void setFragmentsPop(FragmentsPopListener listener) {
